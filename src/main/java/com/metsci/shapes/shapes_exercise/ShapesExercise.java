...
public class ShapesExercise implements GlimpseLayoutProvider{
    ...
    {
    	ShapesExercise provider = new ShapesExercise( );
    ...
    public MultiAxisPlot2D getLayout( ) throws IOException
    {
        ...
        // make it draggable
        DraggablesInputListener inputListener = new DraggablesInputListener( new AxisMouseListener2D( ), null, new ShapesLayer( model ) );
        GlimpseAxisLayout2D center = plot.getLayoutCenter();
        center.removeAllGlimpseListeners();
        center.addGlimpseMouseAllListener( inputListener );
        center.addGlimpseKeyListener( inputListener );
